...
| Material | Purpose |
|---|---|
| daily-finance | Facts, numbers, dates, source list |
| finance-core-analysis | Mechanism, contradiction, scenarios, variables to watch |
| fresh external checks | Only for numbers used in title, opening, core judgment, or falsification |
